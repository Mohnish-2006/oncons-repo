...
class Register(BaseModel):
    name:str; email:EmailStr; password:str; role:str="user"
...
class BookingIn(BaseModel):
    expert_id:int; scheduled_at:datetime
...
class ProfilePatch(BaseModel):
    name:Optional[str]=None; email:Optional[EmailStr]=None; phone:Optional[str]=None
